      ...
      <div className="max-w-5xl mx-auto pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <Link href="/practice/simulation" className="group">
            <div className="bg-white/80 dark:bg-slate-900/80 p-8 sm:p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-200/50 dark:hover:border-slate-600 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col relative overflow-hidden border border-slate-100/80 dark:border-slate-700/50 backdrop-blur-sm">
              {/* Ambient glow */}
              ...
              <div className="flex items-center gap-2 mb-3 flex-wrap">
                <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 dark:text-white font-display">סימולציית מבחן מלאה</h2>
